// messages taken from https://gist.github.com/ClintonLang/399a539046e21083ffe99cd7f5369788, 
// https://gist.github.com/rex/2fda9b32cfff776819b313492cc0d96c
// https://gist.github.com/meain/6440b706a97d2dd71574769517e7ed32
const messages = [
    "that sure looks like the Tailscale logo",
    ...
    "No, I'm awake. I was just resting my eyes.",
    'While you wait, try licking your elbow and watch this screen at the same time...',
    ...
    'After Tuesday, even the calander is saying "WTF".',
    'Ensuring Gnomes are still short.',
    ...
    "Loading Screens are paid actors. No, really. I usually just skip it. You can't? That's weird.",
    'As the skill issuer, I issue you a "skill issue"...',
    'Only the dev has the exclusive right to skip this screen...'
  ].map(m => m.toLowerCase());
